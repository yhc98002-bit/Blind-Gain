...
Machine artifact: `out_orig/r.json`.
...
|---|---:|---|
| A1 real | 4 | `out_orig/arts/support_candidates_a1_real.jsonl` |
| A2 gray | 1 | `out_orig/arts/support_candidates_a2_gray.jsonl` |
| A2b no-image | 5 | `out_orig/arts/support_candidates_a2b_noimage.jsonl` |
| A3 caption | 0 | `out_orig/arts/support_candidates_a3_caption.jsonl` |
