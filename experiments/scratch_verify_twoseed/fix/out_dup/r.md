...
Machine artifact: `out_dup/r.json`.
...
|---|---|---:|---|
| A1 real | seed1 | 4 | `out_dup/arts/support_candidates_a1_real_seed1.jsonl` |
| A1 real | seed2 | 4 | `out_dup/arts/support_candidates_a1_real_seed2.jsonl` |
| A2 gray | seed1 | 1 | `out_dup/arts/support_candidates_a2_gray_seed1.jsonl` |
| A2 gray | seed2 | 1 | `out_dup/arts/support_candidates_a2_gray_seed2.jsonl` |
| A2b no-image | seed1 | 5 | `out_dup/arts/support_candidates_a2b_noimage_seed1.jsonl` |
| A2b no-image | seed2 | 5 | `out_dup/arts/support_candidates_a2b_noimage_seed2.jsonl` |
| A3 caption | seed1 | 0 | `out_dup/arts/support_candidates_a3_caption_seed1.jsonl` |
| A3 caption | seed2 | 0 | `out_dup/arts/support_candidates_a3_caption_seed2.jsonl` |
...
|---|---:|---:|---:|---:|
| A1 real | 0.0947 | 0.0947 | 0.0000 | 0.0947 [0.0105, 0.1789] |
| A2 gray | 0.1158 | 0.1158 | 0.0000 | 0.1158 [0.0316, 0.2000] |
| A2b no-image | 0.1263 | 0.1263 | 0.0000 | 0.1263 [0.0421, 0.2105] |
| A3 caption | 0.1053 | 0.1053 | 0.0000 | 0.1053 [0.0211, 0.1895] |

| Blind arm | Statistic | seed1 | seed2 | Difference | Two-seed mean (registered) |
|---|---|---:|---:|---:|---:|
| A2 gray | aggregate_recovery | 1.2222 | 1.2222 | 0.0000 | 1.2222 |
| A2 gray | rho_gain | 0.0000 | 0.0000 | 0.0000 | 0.0000 |
| A2 gray | rho_recovery | NA | NA | NA | NA |
| A2b no-image | aggregate_recovery | 1.3333 | 1.3333 | 0.0000 | 1.3333 |
| A2b no-image | rho_gain | -0.8660 | -0.8660 | 0.0000 | -0.8660 |
| A2b no-image | rho_recovery | NA | NA | NA | NA |
| A3 caption | aggregate_recovery | 1.1111 | 1.1111 | 0.0000 | 1.1111 |
| A3 caption | rho_gain | 0.8660 | 0.8660 | 0.0000 | 0.8660 |
| A3 caption | rho_recovery | NA | NA | NA | NA |
...
| A1 real | step100_seed2 | `runs/dup_step100_a1_real_seed2` | `241bfc561a9bea78329a28c242cb764fbee7b106e0baa4a2227fd0df1121a9d5` |
...
| A2 gray | step100_seed2 | `runs/dup_step100_a2_gray_seed2` | `515dcebe9c9d2bfbe90be55ac801be12d417c9d4399b065ac1eb5e7b9d283243` |
...
| A2b no-image | step100_seed2 | `runs/dup_step100_a2b_noimage_seed2` | `5c819689148b0e549f03629c92b83f65cd7f6fd031b25a0c4063e5f3cc9fc649` |
...
| A3 caption | step100_seed2 | `runs/dup_step100_a3_caption_seed2` | `236a817458f5b957b33091d19e324ae4175480d1859e18104b7b9174bf160cf0` |
