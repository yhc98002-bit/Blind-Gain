...
COMMAND="python -m src.fliptrack.artifact_attackers --release-dir ${RELEASE_DIR} --key-file ${KEY_FILE} --output ${OUTPUT} --dinov2-model facebook/dinov2-small --batch-size 32 --old-input-jsonl data/fliptrack_v01_manifest.jsonl --n-splits 5 --n-bootstrap 1000 --seed 20260710${EXTRA_ARGS:+ ${EXTRA_ARGS}}"
