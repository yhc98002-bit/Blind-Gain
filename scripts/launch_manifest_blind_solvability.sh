...
if [[ $# -lt 7 || $# -gt 10 ]]; then
  echo "Usage: $0 NODE GPU CONDITION MODEL_PATH MANIFEST SPLIT RUN_TAG [CAPTION_RUN|-] [BATCH_SIZE] [MAX_MODEL_LEN]" >&2
  exit 2
fi
