...
Status:
- Machine audit status: `fail`.
- Machine status JSON: `reports/main_objective_audit_v6.json`.
...
| `required_M0_M1_M4_M13_tasks_pass` | `true` |
| `every_pass_has_all_nonempty_named_reports` | `false` |
...
- Ledger rows: `15`.
- Tasks currently marked pass: `['M0', 'M1', 'M4', 'M8', 'M13']`.
- Audited files examined: `8`.
- Errors: `['pass task M8 lacks non-empty named report: reports/flagship_7b_readiness_v1.md']`.
