...
| `result_registry_rows_follow_registered_state_contract` | `true` |
| `registered_diagnostic_row_is_exact` | `true` |
| `required_terminology_present` | `true` |
| `prohibited_claims_absent` | `true` |
| `figure_builder_and_tests_present` | `true` |

Evidence:
- Machine audit: `reports/paper1_pipeline_status_v9.json`.
