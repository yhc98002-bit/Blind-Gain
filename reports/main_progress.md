...
M2 | blocked | reports/gpu_health_monitor_20260715.md + reports/pilot_retention_recovery_v1.md: A2b retention and registered step-100 R19 lifecycle are complete; A3 serialized retention and a fail-closed step-100 evaluation queue are active; A2 retry2 advanced to step 64 on an12:0-3; A1 retention remains next
...
M12 | blocked | reports/chart_v08_calibration_plumbing_v1.md + reports/chart_v08_human_audit_bundle_v1.json: 100 immutable pairs, 200 necessity-eval rows, and the 100-pair portable human package are mechanically ready; human/model/caption/attacker gates and freeze remain
