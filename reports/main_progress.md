...
M2 | blocked | reports/pilot_a2b_retry1_failure_v1.md: retry1 failed pre-checkpoint from allocator fragmentation; retry2 is authorized only with expandable segments and unchanged scientific config; no registered result is reported
...
M11 | blocked | reports/m11_queue_release_gate_v1.md + reports/m11_runtime_environment_v1.md: all 24 cells remain pending; queue now requires both an29 blind arms to complete before two-poll capacity eligibility, so a failed-arm vacancy cannot launch work
