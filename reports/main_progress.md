...
M2 | blocked | reports/m2_seed1_launch_status_v4.md + reports/pilot_checkpoint_guard_recovery_v1.md: snapshot-guarded A2b retry1 is active on an29 GPUs 0-3 with only output-identity config changes; no registered result is yet reported
