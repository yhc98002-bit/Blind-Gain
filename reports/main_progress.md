...
M2 | blocked | reports/m2_seed1_launch_status_v6.md + reports/m2_seed1_launch_status_v5.md: all four arms are active; retry2 continued after compute-/tmp inode errors, while future retries route Python tempfiles to job-local /dev/shm; no registered result is reported
...
M11 | blocked | reports/m11_execution_queue_status_v6.md + reports/m11_queue_release_gate_v1.md: live queue is waiting for successful completion of both an29 blind arms; zero capacity polls and all 24 cells pending
