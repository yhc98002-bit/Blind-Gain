...
M2 | blocked | reports/m2_seed1_launch_status_v3.md + reports/pilot_checkpoint_guard_recovery_v1.md: A2b failed before its first checkpoint on a recursive quota-probe timeout; no checkpoint exists, snapshot-guarded clean retry is tested and awaits committed launch
