...
M11 | blocked | reports/m11_execution_queue_status_v1.md + reports/m11_processor_preflight_v1.md: 24-cell queue waits for all four M2 manifests; both staged processor stacks pass CPU preflight and six GPU smoke cells still gate the registered matrix
