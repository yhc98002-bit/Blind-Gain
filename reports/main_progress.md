...
M2 | blocked | reports/pilot_a2_resume60_retry2_launch_v1.md + reports/pilot_step60_fliptrack_lifecycle_v1.md: released an21 attempt is excluded, A2 retry2 runs from audited step 60 on an12:0-3, A1/A2b/A3 training is complete, all three available step-60 R19 evaluation/aggregate/marker lifecycles are mechanically complete, and checkpoint retention advances toward step 100
...
M11 | blocked | reports/m11_execution_queue_status_v8.md + reports/m11_runtime_environment_v2.md: retained V1 queue has three Gemma smoke completes, three InternVL dependency failures, and 18 full cells pending; V2 now passes a real local InternVL class import and fresh smokes are next
