...
M5 | blocked | step-100 raw state restored and hash-audited; the one-step integrity run is active on an12 GPUs 0-3, and the fixed step-400 launcher is queued fail-closed behind its machine result
