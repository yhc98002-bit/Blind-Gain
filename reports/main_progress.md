...
M2 | blocked | reports/m2_seed1_launch_status_v1.md: A1, A2b, and fixed A3 retry are running under authorized manifests; A2 gray is queued behind M8 on an12 GPUs 4-7 and no pilot result is yet reported
...
M8 | blocked | reports/m8_7b_prep_launch_status.md: exact-coverage own-caption store plus four TP1 pilot-contract conditions are active on an12 GPUs 4-7; noise and final audited report remain
