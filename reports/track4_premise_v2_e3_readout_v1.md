...
|---|---:|---:|---:|---:|---|---:|---|
| `chained_premise` | 20 | 0.2250 | 0.2250 | 0.2330 | **PASS** / **PASS** | 0.3500 | **PASS** / **PASS** |
| `chained_premise_easy` | 40 | 0.2625 | 0.2625 | 0.2330 | **FAIL** / **FAIL** | 0.3250 | **PASS** / **PASS** |
| `fact_read` | 20 | 0.0750 | 0.0750 | 0.2330 | **PASS** / **PASS** | 0.3000 | **PASS** / **PASS** |
| `premise_transition` | 40 | 0.1125 | 0.1125 | 0.2330 | **PASS** / **PASS** | 0.2375 | **PASS** / **PASS** |
| `premise_transition_easy` | 40 | 0.2125 | 0.2125 | 0.2330 | **PASS** / **PASS** | 0.3250 | **PASS** / **PASS** |

Failing types under reading (a): `chained_premise_easy`. Registered consequence: Fail => the track is caption-leaky: eval-only until revised.
