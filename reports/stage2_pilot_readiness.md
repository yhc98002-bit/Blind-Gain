...
- The pilot is not cleared to launch because P1.1 is still running and P0.2's required parser-agreement sample remains unavailable.
...
- P0.2 remains blocked because the specified recovery logs contain no usable generations for the required >=300 comparison.
...
- Launch the three immutable runs only after dependencies are satisfied.
