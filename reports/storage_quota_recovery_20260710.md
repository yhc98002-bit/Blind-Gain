...
Status:
- Shared-project usage fell from approximately 166 GB to 89 GB.
...
- Current top-level scan: `artifacts/` 42 GB, `experiments/` 16 GB, `checkpoints/` 16 GB, `data/` 7.8 GB, `.venv/` 7.6 GB, `.venv-ocr/` 428 MB; total 89 GB.
- Login `/tmp` has 815 GB capacity and approximately 519 GB free after relocation.
