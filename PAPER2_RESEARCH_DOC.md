...
- **E3 caption stress — running** (7B captioner over all 480 distinct dev images, then QA build restricted to the 320-image causal release, then the 3B caption-QA eval). Verdict per type against blind-floor + 0.10.
